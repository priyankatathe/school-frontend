    ...
    return <>
        {/* <footer className="footer footer-horizontal footer-center bg-primary text-primary-content p-10">
            <aside>
                ...
                <p className="font-bold">
                    DIGITAL ALCHEMY ACADMY
                    <br />
                    Providing reliable tech since 2019
                </p>
                <p>alchemyAcadmy © {new Date().getFullYear()} - All right reserved</p>
            </aside>
            <nav>
        ...
        <footer className="bg-blue-950 text-white py-10 px-6">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* School Info */}
                <div>
                    <h2 className="text-xl font-bold mb-3">🏫 degital alchemy Public School</h2>
                    <p className="text-sm text-gray-300">
                        A place where learning begins and never ends. Providing quality education since 2015.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-300">✉️ digitalschool@gmail.com</p>
                    ...
                    <div className="flex gap-4 mt-4">
                        ...
                        <a href="#" className="text-gray-300 hover:text-white text-lg"><FaLinkedin
                        /></a>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-10 border-t border-gray-700 pt-5 text-center text-sm text-gray-400">
                © {new Date().getFullYear()} degital alchemy Public School. All rights reserved.
            </div>
        </footer>
    </>
}
