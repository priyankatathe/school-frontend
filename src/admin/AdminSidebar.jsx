...
const AdminSidebar = () => {
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className="h-16 flex items-center justify-center text-lg font-bold text-white bg-gradient-to-r from-green-500 to-emerald-600">
          Admin Panel
        </div>
        ...
        <div className="px-4 py-4 border-t">
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2 bg-red-600 text-white py-2 rounded-lg hover:bg-red-700 transition disabled:opacity-60"
          >
            <FaSignOutAlt />
